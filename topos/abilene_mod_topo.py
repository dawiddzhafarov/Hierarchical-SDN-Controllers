...
class AbileneModTopo(Topo):
    ...
    def __init__(self, **opts):
        ...
        h7  = self.addHost('h-ord')
        h8  = self.addHost('h-atl')
        h9  = self.addHost('h-iad')
        h10 = self.addHost('h-nyc')
        ...
        s7  = self.addSwitch('sw-ord', dpid="00:00:00:00:00:00:00:07")
        s8  = self.addSwitch('sw-atl', dpid="00:00:00:00:00:00:00:08")
        s9  = self.addSwitch('sw-iad', dpid="00:00:00:00:00:00:00:09")
        s10 = self.addSwitch('sw-nyc', dpid="00:00:00:00:00:00:00:10")
